"""Email platform adapter for the Tino gateway: users talk to Tino by sending email; IMAP (polled)
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _new_reply(self, to_addr: str, body: str, reply_to_msg_id: Optional[str] = None, *,
        ...
        subject = ctx.get("subject", "Tino Agent")
...
async def _standalone_send(pconfig, chat_id, message, *, thread_id=None, media_files=None, force_document=False):
    ...
    try:
        ...
        for key, value in (("From", address), ("To", chat_id), ("Subject", "Tino Agent"), ("Date", formatdate(localtime=True))):
            msg[key] = value
