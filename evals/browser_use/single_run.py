...
The run gets a throwaway TINO_HOME so no local config leaks in, and the
...
if _or_key:
    ...
    # Resolved by the orchestrator BEFORE TINO_HOME is redirected to the
