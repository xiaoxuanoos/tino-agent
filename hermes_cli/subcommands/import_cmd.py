...
def build_import_cmd_parser(subparsers, *, cmd_import: Callable) -> None:
    ...
    import_parser = subparsers.add_parser(
        "import", help="Restore a Tino backup from a zip file",
        description="Extract a previously created Tino backup into your "
        "Tino home directory, restoring configuration, skills, "
        "sessions, and data")
