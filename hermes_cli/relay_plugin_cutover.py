"""Shared migration guards for Tino's native NeMo Relay ownership."""
...
RELAY_PLUGINS_CONFIG_ENV = "TINO_NEMO_RELAY_PLUGINS_TOML"

LEGACY_RELAY_PLUGIN_KEYS = frozenset({"nemo_relay", "observability/nemo_relay"})

LEGACY_RELAY_EXPORT_ENV_VARS = frozenset({
    "TINO_NEMO_RELAY_ATOF_ENABLED",
    "TINO_NEMO_RELAY_ATOF_OUTPUT_DIRECTORY",
    "TINO_NEMO_RELAY_ATOF_FILENAME",
    "TINO_NEMO_RELAY_ATOF_MODE",
    "TINO_NEMO_RELAY_ATIF_ENABLED",
    "TINO_NEMO_RELAY_ATIF_OUTPUT_DIRECTORY",
    "TINO_NEMO_RELAY_ATIF_FILENAME_TEMPLATE",
    "TINO_NEMO_RELAY_ATIF_AGENT_NAME",
    "TINO_NEMO_RELAY_ATIF_AGENT_VERSION",
    "TINO_NEMO_RELAY_ATIF_EXPORT_TIMEOUT_S",
    "TINO_NEMO_RELAY_ATIF_MODEL_NAME",
    "TINO_NEMO_RELAY_ATIF_SUBAGENT_EXPORT_MODE",
})
