#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Tino logs.
...
With no LOGFILE, reads ``$TINO_HOME/logs/agent.log`` (default ~/.hermes).
...
def default_log() -> Path:
    home = os.environ.get("TINO_HOME") or str(Path.home() / ".hermes")
