#!/usr/bin/env python3
"""Build the Tino Model Catalog — a centralized JSON manifest of curated models.
...
Tino CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Tino release.
...
# Ensure TINO_HOME is set for imports that touch it at module level.
os.environ.setdefault("TINO_HOME", os.path.join(os.path.expanduser("~"), ".hermes"))
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            ...
            "docs": "website/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Tino '
