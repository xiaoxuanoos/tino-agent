...
4. Name the token (e.g., "Tino Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${TINO_HOME:-~/.hermes}/.env`:
...
```bash
CANVAS="python $TINO_HOME/skills/productivity/canvas/scripts/canvas_api.py"
