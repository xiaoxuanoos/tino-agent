...
Data file: $TINO_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_TINO_HOME = Path(os.environ.get("TINO_HOME", Path.home() / ".hermes"))
DATA_DIR = _TINO_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
