...
The design is **Tino-native**: a small deterministic Python CLI (`scripts/pdd.py`) owns the state
...
Then start a new Tino session and drive it (below). The skill works zero-config; a few optional
...
- **PII handling.** Dossiers live under the Tino home directory (`0600`, optionally
