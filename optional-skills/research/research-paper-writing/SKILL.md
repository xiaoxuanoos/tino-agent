...
## Tino Agent Integration

This skill is designed for the Tino agent. It uses Tino tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Tino skills for specific phases:
