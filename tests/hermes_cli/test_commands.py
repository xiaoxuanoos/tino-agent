...
from hermes_cli.commands_platforms import _CMD_NAME_LIMIT, _SLACK_RESERVED_COMMANDS, _SLACK_VIA_TINO_ONLY, _clamp_command_names, _sanitize_telegram_name, slack_app_manifest, slack_native_slashes, slack_subcommand_map, telegram_bot_commands, telegram_menu_commands
...
class TestSlackNativeSlashes:
    ...
    def test_telegram_parity(self):
        ...
        via_hermes_norm = {_norm(n) for n in _SLACK_VIA_TINO_ONLY}
