"""Regression tests: profile TINO_HOME override in ephemeral agent threads (#50233).
...
``TINO_HOME`` ContextVar set on the session-create thread does NOT propagate to
