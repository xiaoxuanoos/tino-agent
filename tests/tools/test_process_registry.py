...
from tools.environments.local_env_policy import _TINO_PROVIDER_ENV_FORCE_PREFIX
...
class TestSpawnEnvSanitization:
    def test_spawn_local_strips_blocked_vars_from_background_env(self, registry):
        ...
        with patch.dict(os.environ, {
            ...
            registry.spawn_local(
                ...
                env_vars={
                    ...
                    f"{_TINO_PROVIDER_ENV_FORCE_PREFIX}TELEGRAM_BOT_TOKEN": "forced-bot-token",
                },
            )
        ...
        assert f"{_TINO_PROVIDER_ENV_FORCE_PREFIX}TELEGRAM_BOT_TOKEN" not in env
...
class TestSystemdCgroupIsolation:
    ...
    def test_inherited_gateway_tree_markers_do_not_scope_child_cli(
        ...
        _TINO_GATEWAY is inherited (and set by importing gateway.run), so
