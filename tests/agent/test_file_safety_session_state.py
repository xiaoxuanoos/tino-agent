...
manipulation. Tino keeps canonical conversation history in state.db and may
...
def fake_homes(tmp_path, monkeypatch):
    """Point TINO_HOME at a temp profile dir.
    ...
    TINO_HOME=<root>/profiles/<name> makes get_default_hermes_root()
