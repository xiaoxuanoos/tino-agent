...
def curator_env(tmp_path, monkeypatch):
    """Isolated TINO_HOME + freshly reloaded curator + skill_usage modules."""
    ...
    # save_state() resolves the state path from TINO_HOME at write time, so a
    ...
    # thread here, while TINO_HOME is still pinned to this test's tmp home
