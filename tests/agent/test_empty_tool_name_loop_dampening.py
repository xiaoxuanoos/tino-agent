...
@pytest.fixture()
def agent_env():
    """Spin up the mock provider + an isolated TINO_HOME, yield (agent, helpers)."""
    ...
    prev_home = os.environ.get("TINO_HOME")
    os.environ["TINO_HOME"] = os.path.join(test_home, ".hermes")
    ...
    try:
        ...
        if prev_home is None:
            ...
            os.environ["TINO_HOME"] = prev_home
