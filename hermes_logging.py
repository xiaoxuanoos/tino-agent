"""Centralized logging setup for Tino Agent.
...
# in Tino (TUI, gateway, hy_memory, MCP servers, CLI commands all log) —
...
def setup_logging(
    *,
    ...
    """Configure the Tino logging subsystem; returns the ``logs/`` directory.
    ...
    # A second Tino home in a process that already logs for another one — a dashboard or
...
class _ProfileRoutingFileHandler(logging.Handler):
    """Route queued records to the log file for their Tino home.
