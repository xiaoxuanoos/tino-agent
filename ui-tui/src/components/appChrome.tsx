...
// a clamped Tino step such as `ultra` reads `ultra→max`, like the CLI's
...
export function StatusRule({
  ...
  // Dev-only readout (TINO_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (TINO_DEV_CREDITS), lowest priority,
