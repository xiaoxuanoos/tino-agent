...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your Tino session"),
        ...
        _cmd("status", "Show Tino session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running Tino agent"),
        ...
        _cmd("update", "Update Tino Agent to the latest version"),
        _cmd("restart", "Gracefully restart the Tino gateway"),
        ...
        _cmd("thread", "Create a new thread and start a Tino session in it",
