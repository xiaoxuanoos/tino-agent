 ...
 *
 * Each entry is a key/value pair that lands in the packaged Tino.app's
 ...
 * "Tino wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Tino wants to access Music" when Tino never touches the Music
