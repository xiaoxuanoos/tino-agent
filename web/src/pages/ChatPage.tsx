...
export default function ChatPage({ isActive = true }: { isActive?: boolean }) {
  ...
  const tokenMissing =
    ...
    !window.__TINO_SESSION_TOKEN__ &&
    !window.__TINO_AUTH_REQUIRED__;
  ...
  useEffect(() => {
    ...
    const gated = !!window.__TINO_AUTH_REQUIRED__;
    ...
    const term = new Terminal({
      ...
      // even when the inner Tino TUI has enabled xterm mouse-events
    ...
    //      payloads upload to TINO_HOME/images then drive `/image`.
    //
    ...
    // must upload browser bytes to TINO_HOME/images, then drive `/image`
    ...
    // WebSocket. In gated mode (``window.__TINO_AUTH_REQUIRED__``) this
    ...
    void (async () => {
      ...
      // Profile-scoped chat: the PTY child gets TINO_HOME pointed at the
    ...
    // forwarding them into Tino. Keyboard input, paste, and resize still
    // behave normally.
