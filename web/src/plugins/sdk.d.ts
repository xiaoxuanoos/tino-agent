/**
 * Tino Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__TINO_PLUGIN_SDK__`` and
 * ``window.__TINO_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__TINO_PLUGIN_SDK__`` because:
 ...
 * of calling ``fetch`` with a hand-read ``window.__TINO_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__TINO_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__TINO_PLUGIN_SDK__)
// ---------------------------------------------------------------------------
...
declare global {
  interface Window {
    __TINO_PLUGIN_SDK__?: HermesPluginSDK;
    __TINO_PLUGINS__?: PluginRegistry;
  }
}
