 ...
 *
 * Plugins call window.__TINO_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__TINO_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__TINO_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__TINO_PLUGIN_SDK__ = {
    ...
    // window.__TINO_SESSION_TOKEN__ directly.
    authedFetch,
