...
//!
//! Resolution order:
//!   1. Dev shortcut: a sibling repo checkout via $TINO_SETUP_DEV_REPO_ROOT
...
//! Electron app's APP_ROOT/../.. trick, because Tino-Setup.exe is meant
...
///
/// `pin` is the commit-or-branch from either Tino-Setup's build-time
...
pub async fn resolve(
    ...
    // 1. Dev shortcut.
    if let Ok(repo_root) = std::env::var("TINO_SETUP_DEV_REPO_ROOT") {
