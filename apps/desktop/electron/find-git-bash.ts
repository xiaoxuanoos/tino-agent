 ...
 *   1. TINO_GIT_BASH_PATH env var override
...
export function findGitBash(opts: GitBashOptions): string | null {
  ...
  // Respect TINO_GIT_BASH_PATH if set (mirrors tools/environments/local.py:_find_bash).
  const gitBashPath = env.TINO_GIT_BASH_PATH
