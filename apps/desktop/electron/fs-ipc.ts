...
// hardening, TINO_HOME resolution, and the git binary stay injected.
...
export function registerFsIpc({
  ...
  // The LOCAL Desktop runtime-plugin root: `<TINO_HOME>/desktop-plugins`,
  // resolved from the main-process TINO_HOME (see resolveHermesHome) — NOT from
  ...
  // The LOCAL logs root (`<TINO_HOME>/logs`, profile-aware) — the error
  // card's "Open Logs" action reveals agent.log/gateway.log without the user
  // knowing where TINO_HOME lives. Same Electron-local resolution as the
