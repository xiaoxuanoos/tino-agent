...
// even though a fresh shell — and the Tino CLI — sees it immediately. The
// desktop's TINO_HOME resolution relies on process.env, so that stale-snapshot
