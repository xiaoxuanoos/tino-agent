...
export function displayName(bot: Partial<RosterRow>, meta?: BotMeta | null): string {
  ...
  // "Tino". Annotated active rows carry sourceScoped too, and keying this
  ...
  // never generic "Tino" or a hostname-derived label.
  if (alias) {
  ...
  // that reads like nobody bothered. Present it as Tino (the agent it is)
