/**
 * Tino Bot Mode — a "one chat per agent" roster for the Tino desktop.
 *
 * Left pane "Bots": one row per Tino profile (a bot = an agent profile) with
 ...
 *
 * Right tile "Routines": scheduled tasks (Tino cron jobs) scoped to the
...
export default {
  ...
  register(ctx: PluginContext) {
    ...
    // A bot's chat before it has spoken: core's splash is Tino' wordmark and
