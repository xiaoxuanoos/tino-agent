/**
 * Tino skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$TINO_HOME/skins/` (or a
 ...
 * skin Tino authors from a prompt lights up all three surfaces from one file.
 *
