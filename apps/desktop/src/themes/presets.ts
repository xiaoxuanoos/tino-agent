...
/**
 * Nous — the canonical Tino desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Tino's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical Tino desktop identity: GitHub's chrome carrying Nous
