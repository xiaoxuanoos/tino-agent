/**
 * Live skin sync from the Tino backend.
 *
 * The backend resolves the active skin (built-in or `$TINO_HOME/skins/*.yaml`)
 ...
 * stomps the user's persisted desktop theme; only a genuine name change (Tino
