...
export const TINO_CONFIG_KEY = ['hermes-config-record'] as const
...
export const hermesConfigKey = (profile?: ProfileScope) =>
  profile == null ? TINO_CONFIG_KEY : ([...TINO_CONFIG_KEY, profileScopeKey(profile)] as const)
...
export const setHermesConfigCache = writeCache<HermesConfigRecord>(TINO_CONFIG_KEY)
