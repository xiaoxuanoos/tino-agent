...
/** Why a known Tino command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active Tino profile', surface: action('profile') },
  {
    name: '/skin',
 ...
 * Tino' built-in slash commands — i.e. skill commands (`/gif-search`,
 ...
 * activity — the ones that ship with Tino and were never asked for. It is
