...
/**
 * E2E smoke tests for the packaged Tino desktop app.
 *
 ...
 * (credential stripping, isolated TINO_HOME + userData, unique app name).
 *
...
test('window opens with the Tino title', async () => {
  const title = await fixture!.page.title()
  expect(title).toContain('Tino')
})
